...
if item_1 in menu:
    ...
    ordered_items.append((item_1.capitalize(), menu[item_1]))  # Capitalizing for nice output
...
if another_order == "yes":
    ...
    if item_2 in menu:
        ...
        ordered_items.append((item_2.capitalize(), menu[item_2]))  # Capitalizing for nice output
